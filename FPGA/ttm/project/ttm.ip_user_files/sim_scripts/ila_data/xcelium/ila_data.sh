...
#
# Script generated by Vivado on Sun Oct 29 19:59:01 -03 2023
...
#
# Usage        : ila_data.sh
#                ila_data.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                ila_data.sh [-reset_run]
#                ila_data.sh [-reset_log]
#                ila_data.sh [-help]
#
...
#                script (type 'ila_data.sh -help' for more information).
#
...
# script info
echo -e "ila_data.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./ila_data.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../ip/ila_data/hdl/verilog" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.ila_data xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.ila_data -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log ila_data_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
Usage: ila_data.sh [-step]\n\
Usage: ila_data.sh [-lib_map_path]\n\
Usage: ila_data.sh [-reset_run]\n\
Usage: ila_data.sh [-reset_log]\n\
Usage: ila_data.sh [-keep_index]\n\
