...
#
# Script generated by Vivado on Sun Oct 29 19:58:14 -03 2023
...
#
# Usage        : fifo_dataprep.sh
#                fifo_dataprep.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                fifo_dataprep.sh [-reset_run]
#                fifo_dataprep.sh [-reset_log]
#                fifo_dataprep.sh [-help]
#
...
#                script (type 'fifo_dataprep.sh -help' for more information).
#
...
# script info
echo -e "fifo_dataprep.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./fifo_dataprep.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.fifo_dataprep xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.fifo_dataprep -input simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/alfredo/Documents/BrightEyes-TTM_Repo/FPGA/ttm/project/compile_simlib/xcelium"
  fi
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log fifo_dataprep_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
Usage: fifo_dataprep.sh [-step]\n\
Usage: fifo_dataprep.sh [-lib_map_path]\n\
Usage: fifo_dataprep.sh [-reset_run]\n\
Usage: fifo_dataprep.sh [-reset_log]\n\
Usage: fifo_dataprep.sh [-keep_index]\n\
